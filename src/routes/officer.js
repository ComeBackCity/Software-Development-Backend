...
const crimeCountPerDivision = require('../functions/visualize/crimeCountPerDivision');
...
router.get('/officer/visualize/crime/perDivision', officer_auth, crimeCountPerDivision);
